// Following code is for the future enhancement of the application
// It is not used in the current version
// It makes use of jwt tokens to authenticate users
// If ever v2 is ever implemented, this code will be used
